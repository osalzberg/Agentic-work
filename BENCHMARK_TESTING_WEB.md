# Benchmark Testing in Web App

The web app now includes built-in benchmark testing functionality for testing multiple prompts at once through Excel files.
...
1. Scroll to the **"📊 Benchmark Test Queries"** section
2. Click **"📁 Choose Excel File"** 
3. Select your Excel file
4. Click **"🚀 Process Benchmark"**
...
- You must connect to a workspace before benchmark testing
...
- Generate queries via benchmark
...
2. Run benchmark to generate queries
